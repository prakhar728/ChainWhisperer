...
contract DeployVulnerable is Script {
    function run() external {
        ...
        VulnerableStaking stakingContract = new VulnerableStaking(address(mockToken));
        ...
        vm.writeFile("vulnerable-addresses.env", addresses);
        console.log("\nAddresses saved to vulnerable-addresses.env");
    }
}