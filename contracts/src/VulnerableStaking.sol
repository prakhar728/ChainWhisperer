 ...
 */
contract VulnerableStaking is ReentrancyGuard, Ownable {
    ...
    // VULNERABILITY 5: Emergency operator can be changed by anyone who becomes authorized
    function setEmergencyOperator(address newOperator) external onlyAuthorized {
